    ...
    <div class="row justify-content-center m-5">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <h1 class="card-title">Área del Cubo</h1>
                    <hr />
                    <div class="row justify-content-center mt-5">
                        <h5 class="col-md-2">Fórmula:</h5>
                        <p class="col-md-4">
                            <strong>Área</strong> = 6 * arista * arista
                        </p>
                    </div>

                    <!-- form -->
                    <form class="row g-3 mt-5" action="../php/area_cubo.php" method="POST">
                        <div class="col-12">
                            <label class="form-label">Arista</label>
                            <input type="number" class="form-control" name="arista" />
                        </div>
