    ...
    <div class="row justify-content-center m-5">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <h1 class="card-title">Área del Hexágono</h1>
                    <hr />
                    <div class="row justify-content-center mt-5">
                        <h5 class="col-md-2">Fórmula:</h5>
                        <p class="col-md-4">
                            <strong>Área</strong> = perímetro * Apotema / 2
                        </p>
                    </div>

                    <!-- form -->
                    <form class="row g-3 mt-5" action="../php/area_hexagono.php" method="POST">
                        <div class="col-12">
