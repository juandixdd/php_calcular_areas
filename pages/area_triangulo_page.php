...
<body>
  <div class="row justify-content-center m-5">
    <div class="col-md-8">
      <div class="card">
        <a class="btn btn-color col-md-1 m-2" href="../index.html"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-backspace-fill" viewBox="0 0 16 16">
